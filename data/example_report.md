...
**Priority 0.65** (importance 0.51, urgency 0.95) | evidence confidence 88% | 89 works | 22 groups
...
| --- | --- | --- | --- |
| importance | impact | 0.38 | _measured_ — 75th-percentile normalised citation impact 1.49x expected across 89 works with citation data |
...
**Priority 0.61** (importance 0.47, urgency 0.90) | evidence confidence 88% | 99 works | 28 groups
...
| Axis | Sub-score | Value | Basis |
| --- | --- | --- | --- |
| importance | impact | 0.40 | _measured_ — 75th-percentile normalised citation impact 1.60x expected across 99 works with citation data |
...
| importance | evidence | 0.70 | _measured_ — mean publication-status weight 0.70 across 99 works, from 28 independent groups |
...
| urgency | competition | 1.00 | _measured_ — 28 independent groups published in the last 12 months |
| urgency | acceleration | 0.71 | _measured_ — 27 works in the last 12 months vs historical mean 16.5/year (ratio 1.64) |
| urgency | industry_entry | 1.00 | _measured_ — 96% of works have at least one industry-affiliated author |
...
**Priority 0.61** (importance 0.51, urgency 0.78) | evidence confidence 88% | 39 works | 16 groups
...
| Axis | Sub-score | Value | Basis |
| --- | --- | --- | --- |
| importance | impact | 0.31 | _measured_ — 75th-percentile normalised citation impact 1.11x expected across 39 works with citation data |
...
| importance | evidence | 0.64 | _measured_ — mean publication-status weight 0.64 across 39 works, from 16 independent groups |
...
| urgency | acceleration | 0.52 | _measured_ — 8 works in the last 12 months vs historical mean 6.5/year (ratio 1.23) |
| urgency | industry_entry | 0.92 | _measured_ — 46% of works have at least one industry-affiliated author |
...
**Priority 0.48** (importance 0.41, urgency 0.61) | evidence confidence 88% | 32 works | 15 groups

Readiness: TRL 2 (Technology concept formulated); 80% credible range 1-6, mean 3.6

### Why it scores this way

| Axis | Sub-score | Value | Basis |
| --- | --- | --- | --- |
| importance | impact | 0.40 | _measured_ — 75th-percentile normalised citation impact 1.59x expected across 32 works with citation data |
...
| importance | evidence | 0.65 | _measured_ — mean publication-status weight 0.65 across 32 works, from 15 independent groups |
...
| urgency | industry_entry | 0.50 | _measured_ — 25% of works have at least one industry-affiliated author |
